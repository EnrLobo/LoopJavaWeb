...
INSERT INTO `game` (`idGame`, `titulo`, `descricao`, `preco`, `lancamento`, `desenvolvedora_idDev`) VALUES
	...
	(4, 'Dark Souls 341', 'Dark souls e bom 2', 300, '2021-12-01', 4),
	(5, 'Teste', 'aopa', 100, '2003-12-01', 1),
	(6, 'teste3434', 'qwewqqwe', 100, '2003-12-01', 3),
	(7, 'lobinho oia', 'olhando', 120, '2003-12-02', 1);
...
-- Copiando dados para a tabela loop.metodo_pagamento: ~1 rows (aproximadamente)
INSERT INTO `metodo_pagamento` (`idPaga`, `nome`, `descricao`, `taxa`) VALUES
	(1, 'pix', 'pix', 0);
...
-- Copiando dados para a tabela loop.pedido: ~1 rows (aproximadamente)
INSERT INTO `pedido` (`idPedido`, `user_id`, `pagamento_id`, `data_pedido`) VALUES
	(4, 20, 1, '2024-08-18');
...
-- Copiando dados para a tabela loop.usuario: ~14 rows (aproximadamente)
INSERT INTO `usuario` (`idUser`, `nome`, `email`, `senha`, `pais`, `pontos`) VALUES
	...
	(20, 'kkjao', 'kkjaokk@gmail.com', '$2a$10$ksRBGqfgYlwoTJyR9uNiXuJD1z.yr.iBXMOacdNE9CR6NJ5mfb.ym', 'Brasil', 1000);
